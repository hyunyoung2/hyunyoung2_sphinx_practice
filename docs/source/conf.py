...
htmlhelp_basename = 'practiceofsphinxdoc'
...
man_pages = [
    (master_doc, 'practiceofsphinx', 'practice of sphinx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'practiceofsphinx', 'practice of sphinx Documentation',
     author, 'practiceofsphinx', 'One line description of project.',
     'Miscellaneous'),
]
